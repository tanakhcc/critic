    ...
    view! {
      ...
      <div class="flex flex-row justify-center">
        <div class="grid w-3/4 grid-cols-3 gap-8">
          <a href="/admin/manuscripts" class="rounded-4xl border-2 border-sky-600 bg-slate-700 p-8 shadow-lg shadow-sky-600 hover:bg-slate-600 hover:shadow-xl">
          ...
          <a href="/admin/versification" class="rounded-4xl border-2 border-sky-600 bg-slate-700 p-8 shadow-lg shadow-sky-600 hover:bg-slate-600 hover:shadow-xl">
            <div class="flex flex-row justify-start">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-14">

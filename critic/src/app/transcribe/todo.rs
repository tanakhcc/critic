                ...
                <div id="page-listing" class="text-md table w-4/5">
                    <div class="table-row-group">
                        ...
                        >
                            ...
                            <div class="table-cell border-r border-inherit p-2 text-green-500">
                                <div class="inline-flex translate-y-2">
                                    ...
                                    <span class="pr-2 pl-4 font-extrabold">2</span>
                                    already done
                                </div>
                            </div>
                            <div class="table-cell border-r border-inherit p-2 font-bold">
                                already started
                            </div>
                        ...
                        <div class="table-row border-b border-slate-600 py-3 text-xl shadow-sky-600 last:border-b-0 odd:bg-slate-800 even:bg-slate-600 hover:bg-sky-900 hover:shadow-2xl">
                            ...
                            <div class="table-cell border-r border-inherit p-2">
                                <span class="pl-12 font-extrabold mr-2">1</span>
                                already done
                            </div>
                            <div class="table-cell border-r border-inherit p-2 font-bold">
                                already started
                        ...
                        <div class="table-row border-b border-slate-600 py-3 text-xl shadow-sky-600 last:border-b-0 odd:bg-slate-800 even:bg-slate-600 hover:bg-sky-900 hover:shadow-2xl">
                            ...
                            <div class="table-cell border-r border-inherit p-2">
                                <span class="pl-12 mr-2 font-bold">0</span>
                                done
                            </div>
                            <div class="table-cell border-r border-inherit p-2 font-bold">
                                already started

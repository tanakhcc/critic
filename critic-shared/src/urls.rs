...
/// The api endpoint where new ml models should be uploaded to
/// The type will be appended after a trailing `/`. The Model name will be set from the filename
pub const MODEL_UPLOAD_API_ENDPOINT: &str = "/v1/model";

...
CREATE TABLE line (
	...
	region BIGINT NOT NULL REFERENCES region(id) ON DELETE CASCADE,
	--- the baseline.
	--- coordinates for baseline and boundary are +x to the right, +y to the bottom, starting from the top-left, in px
